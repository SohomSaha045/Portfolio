...
const Skill = ({ name, x, y,color }:skill) => {
  return (
    <motion.div
      className= {`flex items-center justify-center rounded-full font-semibold text-gray-950 py-3 px-6 shadow-dark cursor-pointer absolute ${color}`} 
  ...
  return (
    <>
      <div className="w-[85%] h-screen relative flex items-center justify-center rounded-full bg-circularLight max-md:w-[100%] max-md:h-full max-md: my-32">
        ...
        <Skill name="HTML" x="-5vw" y="-11vw" color="bg-red-300" />
        <Skill name="CSS" x="-20vw" y="2vw" color="bg-orange-300"/>
        <Skill name="JavaScript" x="15vw" y="7vw" color="bg-amber-300"/>
        <Skill name="Python" x="19vw" y="-4vw" color="bg-yellow-300"/>
        ...
        <Skill name="NodeJS" x="32vw" y="-5vw" color="bg-teal-300"/>
        ...
        <Skill name="Java" x="28vw" y="14vw" color="bg-Indigo-300"/>
        <Skill name="Figma" x="2vw" y="21vw" color="bg-violet-300"/>
      </div>
    </>
  );
};
